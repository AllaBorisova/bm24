...
const buttonEnvironment = document.querySelector('#add-environment');
...
const buttonChoice = document.querySelector('#add-choice');
...
const buttonReason = document.querySelector('#add-reason');
